...
<div class="container">
    <form action="{{ route('mahasiswa.updateSKPI', $user->id) }}" method="POST">
        @csrf
                ...
                <table class="table" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{route('mahasiswabukti.destroy',$bukti->id)}}" method="POST">
                                    @csrf @method('DELETE')
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="{{ route('mahasiswabukti.store') }}" enctype="multipart/form-data">
                    @csrf
